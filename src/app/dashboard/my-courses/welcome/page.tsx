  ...
  return (
    <main className="min-h-screen px-5 py-8 sm:px-8 xl:px-10">
      <section className="overflow-hidden rounded-3xl bg-gradient-to-br from-violet-600 via-fuchsia-600 to-teal-500 p-6 text-white shadow-xl sm:p-10">
        ...
        <h1 className="mt-6 max-w-3xl text-3xl font-black tracking-tight sm:text-5xl">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-white px-6 py-4 text-sm font-black text-violet-700 transition hover:scale-[1.02]"
          >
            Start week 1
            <ArrowRight size={18} />
          </Link>
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-xl border border-white/30 bg-white/10 px-6 py-4 text-sm font-black text-white transition hover:bg-white/15"
          >
            All my courses
          </Link>
        </div>
      ...
      <section className="mt-8 grid gap-6 lg:grid-cols-2">
        <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/5 sm:p-8">
          ...
          {firstWeek ? (
            <>
              <h2 className="mt-3 text-2xl font-black">{firstWeek.week}</h2>
              <ul className="mt-4 space-y-2">
                {firstWeek.topics.map((topic) => (
                  <li key={topic} className="flex items-start gap-2 text-sm font-semibold text-zinc-600 dark:text-zinc-400">
              ...
              {weekResources.length > 0 ? (
                <div className="mt-5">
                  <p className="text-xs font-black uppercase tracking-[0.18em] text-zinc-500">Week 1 resources</p>
        ...
        <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/5 sm:p-8">
          <p className="text-xs font-black uppercase tracking-[0.18em] text-zinc-500">Before you begin</p>
          <h2 className="mt-3 text-2xl font-black">Set up for success</h2>
          <ul className="mt-5 space-y-4">
            {[
              ...
              <li key={tip} className="flex items-start gap-3 text-sm leading-6 text-zinc-600 dark:text-zinc-400">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link
              ...
              className="rounded-xl border border-zinc-200 px-4 py-2.5 text-sm font-black dark:border-white/10"
            >
              Profile settings
            </Link>
            {hasSyllabusPdf(courseSlug) ? (
              <a
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-zinc-950 px-4 py-2.5 text-sm font-black text-white dark:bg-white dark:text-zinc-950"
              >
                <Download size={14} />
                Syllabus PDF
              </a>
      ...
      <section className="mt-8 rounded-3xl border border-dashed border-zinc-300 bg-[#f7f8f5] p-6 text-center dark:border-white/10 dark:bg-zinc-950 sm:p-8">
        ...
        <p className="mt-3">
          <a href={syllabusUrl(courseSlug)} download className="text-xs font-bold text-zinc-500 hover:underline">
