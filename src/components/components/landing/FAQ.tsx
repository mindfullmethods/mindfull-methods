    ...
    <section className="bg-white py-28">
      <div className="mx-auto max-w-4xl px-6">
        ...
        <div className="text-center">
          <span className="rounded-full border bg-gray-50 px-4 py-2 text-sm font-medium shadow-sm">
            FAQ
          </span>
        ...
        {/* Accordion */}
        <div className="mt-16 rounded-3xl border border-black/5 bg-white p-4 shadow-lg">
